...
<Tabs>
  <Tab title="macOS">
    <Steps>
      ...
      <Step title="Configure Claude Desktop">
        Open your Claude Desktop App configuration at `~/Library/Application Support/Claude/claude_desktop_config.json` in a text editor. If this file doesn't exist, you'll need to create it first.

        For example, if you have [VS Code](https://code.visualstudio.com/) installed:

        ```bash
        # Open or create the config file in VS Code
  ...
  <Tab title="Windows">
    <Steps>
      ...
      <Step title="Configure Claude Desktop">
        Open your Claude Desktop App configuration at `%APPDATA%\Claude\claude_desktop_config.json` in a text editor. If this file doesn't exist, you'll need to create it first.
