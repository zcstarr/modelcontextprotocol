...
All communication happens entirely on your machine&mdash;no data leaves your computer. The MCP protocol ensures that Claude Desktop can only perform approved database operations through well-defined interfaces.
...
- [Claude Desktop](https://claude.ai/download) v0.7.0 or newer installed (Claude > About Claude to check)
